...
var renderStateGridMap = function(config) {
    ...
    _.each(config['data'], function(state) {
        if (state['category1992'] != null) {
            categories.push(state['category1992']);
        }
    });
    ...
    _.each(config['data'], function(state) {
        if (state['category1992'] !== null) {
            ...
            chartElement.select('.' + stateClass)
                ...
                .attr('fill', colorScale(state['category1992']));
        }
    });
    ...
    chartElement.append('g')
        ...
        .enter().append('text')
            ...
            .attr('class', function(d) {
                return d['category1992'] !== null ? 'label label-active' : 'label';
            })
            .attr('x', function(d) {
