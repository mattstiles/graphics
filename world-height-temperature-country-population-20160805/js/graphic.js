...
var renderDotChart = function(config) {
    ...
    chartElement.append('g')
        ...
        .enter().append('circle')
			...
			.attr("r", function(d) {
			    return Math.sqrt(d[Population]/1000000);
			})
			// .attr('r', dotRadius)
    ...
    chartElement.append('text')
        ...
        .attr('text-anchor', 'middle')
        .attr('y', yScale(157.2))
        .html(LABELS['annotation_hundredm'])
		  
    chartElement.append('text')
        .attr('class', 'threehundredm')
        .attr('x', xScale(-4.8))
        .attr('dx', 0)
        .attr('text-anchor', 'middle')
        .attr('y', yScale(158.9))
        .html(LABELS['annotation_threehundredm'])
		  
    chartElement.append('text')
        .attr('class', 'population-header')
        .attr('x', xScale(-4.8))
        .attr('dx', 0)
        .attr('text-anchor', 'middle')
        .attr('y', yScale(160.5))
        .html(LABELS['annotation_population-header'])
