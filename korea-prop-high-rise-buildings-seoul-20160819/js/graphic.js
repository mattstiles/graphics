...
var renderStackedColumnChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ COLORS['cbpurple2'], COLORS['cbpurple5'] ]);
...
// Label 2015 value on mobile
	...
	label_2015 = d3.time.format('%m/%d/%y').parse('01/01/15');
  	...
  	chartElement.append('text')
        .attr('class', 'highlight-label label-other-2015')
        .text(' ')
        .attr('x', xScale(label_2015) + 10)
		.attr('y', yScale(1510))
    	.html(LABELS['annotation_label-other-2015']);
		
  	chartElement.append('text')
        .attr('class', 'highlight-label label-seoul-2015')
        .text(' ')
        .attr('x', xScale(label_2015) + 10)
		.attr('y', yScale(120))
    	.html(LABELS['annotation_label-seoul-2015']);
