...
var renderStateGridMap = function(config) {
    ...
    _.each(config['data'], function(state) {
        if (state['category2004'] != null) {
            categories.push(state['category2004']);
        }
    });
    ...
    _.each(config['data'], function(state) {
        if (state['category2004'] !== null) {
            ...
            chartElement.select('.' + stateClass)
                ...
                .attr('fill', colorScale(state['category2004']));
        }
    });
    ...
    chartElement.append('g')
        ...
        .enter().append('text')
            ...
            .attr('class', function(d) {
                return d['category2004'] !== null ? 'label label-active' : 'label';
            })
            .attr('x', function(d) {
