...
var renderStackedColumnChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ COLORS['teal3'], COLORS['yellow3'] , COLORS['red3'], COLORS['blue3'], COLORS['orange3']]);
    ...
    var xAxis = d3.svg.axis()
        ...
        .tickValues(function(d, i) {
            if (isMobile) {
                return [1790,1850,1900,1950,2010];
            } else {
                return [1800,1820,1840,1860,1880,1900, 1920, 1940, 1960,1980,2000,2015];
            }
        });
	...
	var locationLabels = chartElement.append('g')
        .attr('class', 'locations');
    locationLabels.append('text')
        .text('Manhattan')
        .attr('x', chartWidth + 1)
		.attr('y', yScale(68))
