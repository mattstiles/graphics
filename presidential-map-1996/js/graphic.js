...
var renderStateGridMap = function(config) {
    ...
    _.each(config['data'], function(state) {
        if (state['category1996'] != null) {
            categories.push(state['category1996']);
        }
    });
    ...
    _.each(config['data'], function(state) {
        if (state['category1996'] !== null) {
            ...
            chartElement.select('.' + stateClass)
                ...
                .attr('fill', colorScale(state['category1996']));
        }
    });
    ...
    chartElement.append('g')
        ...
        .enter().append('text')
            ...
            .attr('class', function(d) {
                return d['category1996'] !== null ? 'label label-active' : 'label';
            })
            .attr('x', function(d) {
