...
var renderLineChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([COLORS['#f0617f'], COLORS['yellow3'], COLORS['blue3'], COLORS['orange3'], COLORS['teal3']]);
    ...
    var samesex = d3.time.format('%Y').parse('2012')
    ...
    highlight_g.append('text')
        .attr('class', 'highlight-label label-samsex')
        .text(' ')
        .attr('text-anchor', 'middle')
        .attr('x', xScale(samesex))
        .attr('y', yScale(7.6))
        .html(LABELS['annotation_samesex']);
    ...
    chartElement.append('g')
        ...
        .enter().append('text')
            .attr('x', function(d, i) {
                var first = d['values'][d['values'].length - 19];
            ...
            .text(function(d) {
                ...
                var startdate = d3.time.format('%Y').parse('1997')


                if (!isMobile) {
                    label = label + " marriages per 1,000";
                }
    ...
    chartElement.append('g')
        ...
        .append('circle')
            ...
            .attr('cy', function(d) {
                ...
                return yScale(first[valueColumn]);
            })
            .attr('r', 3)
            .attr('class', function(d, i) {
                return 'dots ' + classify(d['name']);
