...
var renderStateGridMap = function(config) {
    ...
    _.each(config['data'], function(state) {
        if (state['category2012'] != null) {
            categories.push(state['category2012']);
        }
    });
    ...
    _.each(config['data'], function(state) {
        if (state['category2012'] !== null) {
            ...
            chartElement.select('.' + stateClass)
                ...
                .attr('fill', colorScale(state['category2012']));
        }
    });
    ...
    chartElement.append('g')
        ...
        .enter().append('text')
            ...
            .attr('class', function(d) {
                return d['category2012'] !== null ? 'label label-active' : 'label';
            })
            .attr('x', function(d) {
