...
var renderStateGridMap = function(config) {
    ...
    _.each(config['data'], function(state) {
        if (state['category1980'] != null) {
            categories.push(state['category1980']);
        }
    });
    ...
    _.each(config['data'], function(state) {
        if (state['category1980'] !== null) {
            ...
            chartElement.select('.' + stateClass)
                ...
                .attr('fill', colorScale(state['category1980']));
        }
    });
    ...
    chartElement.append('g')
        ...
        .enter().append('text')
            ...
            .attr('class', function(d) {
                return d['category1980'] !== null ? 'label label-active' : 'label';
            })
            .attr('x', function(d) {
