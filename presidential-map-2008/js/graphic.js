...
var renderStateGridMap = function(config) {
    ...
    _.each(config['data'], function(state) {
        if (state['category2008'] != null) {
            categories.push(state['category2008']);
        }
    });
    ...
    _.each(config['data'], function(state) {
        if (state['category2008'] !== null) {
            ...
            chartElement.select('.' + stateClass)
                ...
                .attr('fill', colorScale(state['category2008']));
        }
    });
    ...
    chartElement.append('g')
        ...
        .enter().append('text')
            ...
            .attr('class', function(d) {
                return d['category2008'] !== null ? 'label label-active' : 'label';
            })
            .attr('x', function(d) {
