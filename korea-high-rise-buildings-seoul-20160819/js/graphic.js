...
var renderColumnChart = function(config) {
	...
	// Label 2015 value on mobile
		...
		label_2005 = d3.time.format('%m/%d/%y').parse('01/01/05');
	
	  	chartElement.append('text')
	        .attr('class', 'highlight-label label-2015')
	        .text(' ')
	        .attr('x', xScale(label_2015) + 10)
			.attr('y', yScale(1510))
        	.html(LABELS['annotation_label-2015']);
			
	  	chartElement.append('text')
	        .attr('class', 'highlight-label label-2005')
	        .text(' ')
	        .attr('x', xScale(label_2005) + 10)
			.attr('y', yScale(185))
        	.html(LABELS['annotation_label-2005']);
