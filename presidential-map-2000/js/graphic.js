...
var renderStateGridMap = function(config) {
    ...
    _.each(config['data'], function(state) {
        if (state['category2000'] != null) {
            categories.push(state['category2000']);
        }
    });
    ...
    _.each(config['data'], function(state) {
        if (state['category2000'] !== null) {
            ...
            chartElement.select('.' + stateClass)
                ...
                .attr('fill', colorScale(state['category2000']));
        }
    });
    ...
    chartElement.append('g')
        ...
        .enter().append('text')
            ...
            .attr('class', function(d) {
                return d['category2000'] !== null ? 'label label-active' : 'label';
            })
            .attr('x', function(d) {
