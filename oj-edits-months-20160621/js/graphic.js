...
var renderColumnChart = function(config) {
     ...
     * Create D3 axes.
     */
	var tickLabels = ['\'03',' ','\'05',' ','\'07',' ','\'09',' ','\'11',' ','\'13',' ','\'15',' ']
    var xAxis = d3.svg.axis()
        .scale(xScale)
        .orient('bottom')
		.tickValues(['Jan. 2003','2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015','2016'])
    ...
    chartElement.append('text')
	    ...
	    .text('— Sept. \'07: O.J. Arrested (232 edits) ')
	    .attr('x', xScale('Sep-07'))
		.attr('y', yScale(225));
