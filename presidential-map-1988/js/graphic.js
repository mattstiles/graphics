...
var renderStateGridMap = function(config) {
    ...
    _.each(config['data'], function(state) {
        if (state['category1988'] != null) {
            categories.push(state['category1988']);
        }
    });
    ...
    _.each(config['data'], function(state) {
        if (state['category1988'] !== null) {
            ...
            chartElement.select('.' + stateClass)
                ...
                .attr('fill', colorScale(state['category1988']));
        }
    });
    ...
    chartElement.append('g')
        ...
        .enter().append('text')
            ...
            .attr('class', function(d) {
                return d['category1988'] !== null ? 'label label-active' : 'label';
            })
            .attr('x', function(d) {
